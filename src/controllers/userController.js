...
const getUserById = async (req, res) => {
  try {
    ...
    const user = await User.findById(userId).select("name email isAdmin isActive wallet referrals uplineCommisions name_beneficiary email_beneficiary withdrawalWallets");
